...
#ifndef FASTCGI_DAEMON_ERROR_HPP_INCLUDED
#define FASTCGI_DAEMON_ERROR_HPP_INCLUDED
...
class FASTCGI_DAEMON_API error : public std::exception {
};

} // namespace

#endif // FASTCGI_DAEMON_ERROR_HPP_INCLUDED
